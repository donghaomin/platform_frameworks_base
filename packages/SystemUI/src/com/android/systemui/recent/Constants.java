...
public class Constants {
    ...
    public static final int CLEAR_ALL_RECENTS_BUTTON_OFF = 0;
    public static final int CLEAR_ALL_RECENTS_BUTTON_TOP_LEFT = 1;
    public static final int CLEAR_ALL_RECENTS_BUTTON_TOP_RIGHT = 2;
    public static final int CLEAR_ALL_RECENTS_BUTTON_BOTTOM_LEFT = 3;
    public static final int CLEAR_ALL_RECENTS_BUTTON_BOTTOM_RIGHT = 4;
}
