...
public class RecentsPanelView extends FrameLayout implements OnItemClickListener, RecentsCallback,
    ...
    private void updateClearButton() {
        int clearAllRecentsButton = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.CLEAR_ALL_RECENTS_BUTTON, Constants.CLEAR_ALL_RECENTS_BUTTON_TOP_RIGHT);

        if (clearAllRecentsButton != Constants.CLEAR_ALL_RECENTS_BUTTON_OFF) {
            ...
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams)mClearAllRecents.getLayoutParams();
             switch (clearAllRecentsButton) {
                case Constants.CLEAR_ALL_RECENTS_BUTTON_TOP_LEFT:
                    layoutParams.gravity = Gravity.TOP | Gravity.LEFT;
                    break;
                case Constants.CLEAR_ALL_RECENTS_BUTTON_TOP_RIGHT:
                    layoutParams.gravity = Gravity.TOP | Gravity.RIGHT;
                    break;
                case Constants.CLEAR_ALL_RECENTS_BUTTON_BOTTOM_LEFT:
                    layoutParams.gravity = Gravity.BOTTOM | Gravity.LEFT;
                    break;
                case Constants.CLEAR_ALL_RECENTS_BUTTON_BOTTOM_RIGHT:
                default:
    ...
    protected void onFinishInflate() {
        ...
        mClearAllRecents = (ImageView) findViewById(R.id.clear_all_recents);
